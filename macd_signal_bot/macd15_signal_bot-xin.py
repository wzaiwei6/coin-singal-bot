...
TIMEFRAMES = ["15m"]  # 15min trade singal bot
...
# 状态文件路径
STATE_FILE = os.path.join(os.path.dirname(__file__), ".macd_state_15-2.json")

# 企业微信配置
SEND_WECHAT = True
WECHAT_WEBHOOK_URL = os.getenv("MACD_WECHAT_WEBHOOK_URL", "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=5101f603-c140-4576-a19c-50bdc565856e")
