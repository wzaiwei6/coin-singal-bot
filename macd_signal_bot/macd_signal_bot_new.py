...
# 状态文件路径
STATE_FILE = os.path.join(os.path.dirname(__file__), ".macd_state.json")

# 企业微信配置
SEND_WECHAT = True
WECHAT_WEBHOOK_URL = os.getenv("MACD_WECHAT_WEBHOOK_URL", "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=ca74d47c-faa9-4700-bd23-2fbf9dd27bea")
...
def format_macd_message(symbol: str, result: Dict) -> str:
    ...
    message += f"MACD参数：({MACD_FAST}, {MACD_SLOW}, {MACD_SIGNAL})\n\n"
