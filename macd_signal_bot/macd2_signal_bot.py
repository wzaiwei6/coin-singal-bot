...
TIMEFRAMES = ["3m", "5m"]  # 必须4个周期同时满足"15m", "1h"
...
# 定时轮询配置
POLL_INTERVAL = 150  # 轮询间隔（秒），默认3分钟

# 状态文件路径
STATE_FILE = os.path.join(os.path.dirname(__file__), ".macd_state_2.json")#2周期json文件

# 企业微信配置
SEND_WECHAT = True
WECHAT_WEBHOOK_URL = os.getenv("MACD_WECHAT_WEBHOOK_URL", "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=8935cc93-4ad0-4095-a763-2e9027adb42f")
