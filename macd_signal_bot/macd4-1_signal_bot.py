...
TIMEFRAMES = ["1m","3m", "5m","15m"]  # 4个周期同时满足条件时告警
...
# 状态文件路径
STATE_FILE = os.path.join(os.path.dirname(__file__), ".macd_state_4-1.json")

# 企业微信配置
SEND_WECHAT = True
WECHAT_WEBHOOK_URL = os.getenv("MACD_WECHAT_WEBHOOK_URL", "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=809866dc-0688-40ee-88b3-da053c135982")
