...
TIMEFRAMES = ["1m","3m", "5m","15m","1h"]  # 5个周期同时满足条件时告警
...
# 状态文件路径
STATE_FILE = os.path.join(os.path.dirname(__file__), ".macd_state_5.json")

# 企业微信配置
SEND_WECHAT = True
WECHAT_WEBHOOK_URL = os.getenv("MACD_WECHAT_WEBHOOK_URL", "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=f10d4b83-be8e-49d9-8816-e83baf23a5c1")
